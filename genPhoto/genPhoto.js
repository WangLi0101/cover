...
(async () => {
  ...
  const filePath = path.join(__dirname, "html", "stacking-context-cover.html");
  ...
  if (element) {
    ...
    if (box) {
      ...
      const pngPath = path.join(outputDir, "stacking-context-cover.png");
      const webpPath = path.join(outputDir, "stacking-context-cover.webp");
